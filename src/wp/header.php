...
<html lang="<?php echo ($lang===18)  ? 'en' :'ru';?>">
	<head>
		...
		<title>ESM</title>
		<link rel="shortcut icon" href="/wp-content/themes/esm/assets/img/favicon.png" type="image/x-icon">
...
<body class="page-body <?php if ($pagename === 'portfolio' || $pagename === 'policy') echo 'portfolio-page';?>">
	...
	<header class="header" id="header">
		...
		<div class="header__logo-block">
			<a href="/<?php echo ($lang===18)  ? '?lang=en' :'?lang=ru' ;?>"><img src="/wp-content/themes/esm/assets/img/logo.svg" alt="logo" class="header__logo"></a>
		</div>
