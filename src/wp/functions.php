...
/**
 * ESM only works in WordPress 4.7 or later.
 */
...
function twentyseventeen_setup() {
	 ...
	 * If you're building a theme based on ESM, use a find and replace
	...
	/**
	 * Filters ESM array of starter content.
	 *
	 * @since ESM 1.1
	 *
...
function twentyseventeen_content_width() {
	...
	/**
	 * Filter ESM content width of the theme.
	 *
	 * @since ESM 1.0
	 *
